...
public class RecupNF {
	...
	public static void main(String[] args) {
		...
		try{
			...
			FileReader fileNameTam = new FileReader("D:\\users\\f18867b\\Documents\\TODO List\\Recuperação de NF Peças\\Dezembro\\SAL0.txt");
			BufferedReader lerArqTam = new BufferedReader(fileNameTam);
			String linhaTam = lerArqTam.readLine(); // lê a primeira linha

			FileWriter fileNameTamOut = new FileWriter("D:\\users\\f18867b\\Documents\\TODO List\\Recuperação de NF Peças\\Dezembro\\SAL1.txt");
